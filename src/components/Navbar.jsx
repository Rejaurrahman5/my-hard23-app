...
<div className='w-11/12 mx-auto flex justify-between items-center'>
    ...
    <div className='flex items-center gap-10'>
        <a className=" text-2xl font-grif">DRAMATIC</a>
  ...
  <div className="navbar-end flex gap-6">
   <label className="flex items-center gap-2 bg-white/10 rounded-full px-3 py-2 
   border border-transparent focus-within: border-yellow-400 transition duration-300">
  ...
  <input type="search" required placeholder="Search" className='bg-transparent outline-none 
   text-sm text-white placeholder-white/60 w-24 md:w-40'/>
</label>
